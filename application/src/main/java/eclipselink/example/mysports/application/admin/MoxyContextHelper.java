...
public class MoxyContextHelper {
	...
	public static JAXBContext getContext() throws JAXBException {
		if (jaxbContext == null) {
			...
			jaxbContext = JAXBContextFactory.createContext(
					new Class[] { HostedLeagues.class }, props);
		}
		return jaxbContext;
	}

	public static Marshaller createMarshaller(MediaType mediaType)
	...
	public static Unmarshaller createUnmarshaller(MediaType mediaType)
			throws JAXBException {
